  ...
  return (
    <Html lang="zh-TW">
      <Head>
        ...
        <meta name="description" content="精湛資訊工作室 - 現代網站開發、AI 技術整合、行動應用與自動化服務。" />
        <meta name="keywords" content="網站開發, Next.js, React, AI 整合, ChatGPT, LineBot, 前端, 後端, 台北, 客製化網站" />
        ...
        <meta property="og:description" content="現代網站開發與 AI 整合，打造高效能的數位體驗。" />
        ...
        <meta name="twitter:description" content="現代網站開發與 AI 整合，打造高效能的數位體驗。" />
