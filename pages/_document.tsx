  ...
  return (
    <Html lang="zh-TW">
      <Head>
        ...
        <meta name="author" content="Superb Tech Studio" />
        ...
        <meta property="og:description" content="專業網站開發、AI 技術整合與數位轉型解決方案。提供 Next.js、React 開發、ChatGPT 整合、LineBot 等服務，協助企業打造高效能數位體驗。" />
        ...
        <meta name="twitter:description" content="專業網站開發、AI 技術整合與數位轉型解決方案。提供 Next.js、React 開發、ChatGPT 整合、LineBot 等服務。" />
